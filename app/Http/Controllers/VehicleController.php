...
class VehicleController extends Controller
{
   public function create()
    ...
    public function record(Vehicle $vehicle)
    {
        $vehicle->load(['maintenances', 'carType', 'brand', 'maintenances.details']);

        return view('cars.record', compact('vehicle'));
    }

    public function carDetails(User $user, Vehicle $vehicle)
    {
