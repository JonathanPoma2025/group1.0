<x-layoutbg1>
    <div
        ...
        <article class="align-baseline text-center">
            ...
            <p class="mt-6">consejos y herramientas para el mantenimiento de tu auto y recomendaciones para mantenerlo
                en buen estado
            </p>

            <div class="flex justify-center mt-8 items-center">
                <img src="{{ asset('Images/circle 1.png') }}" alt="" class="rotate-180 w-8">
