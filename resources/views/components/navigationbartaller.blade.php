<x-layout>
        <div class="bg-ourblack bg-opacity-60 blackdrop-blur p-5 w-11/12 md:w-7/12 shadow-lg flex justify-around rounded-full fixed bottom-10 left-1/2 transform -translate-x-1/2">
            <div>
