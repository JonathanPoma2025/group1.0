<x-layoutbg1 title="update">
    ...
    <div class="h-screen flex flex-col items-center justify-center">
        <div class="py-12 px-20 bg-ourblack bg-opacity-30  drop-shadow-2xl rounded-[24px] pt-4 pl-10 pr-10 pb-10 mb-6 shadow-2xl w-5/6">
            ...
            <form action="/update" method="GET"  class="text-center mt-6">
                ...
                <x-input id="number" name="number" type="number">Numero de telefono</x-input>
